...
public class Main {
    public static void main(String[] args) {
        ...
        String roundId = "R1";
        String zoneId = "A1";
        String token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..dBYmVw-lU35AyxcFY3s_5d6zivAkT24zkuRP62MJZdM";
                    ...
                    if ("A".equalsIgnoreCase(seatList.get(i).getStatus())) {
                        if ("1".equalsIgnoreCase(seatList.get(i).getSeatNo())) {
                            if ("A".equalsIgnoreCase(seatList.get(i+1).getStatus())) {
                                ...
                                new HandlerReserve().handlerReserveBooking(performId, roundId, zoneId, seatTo, token);
                            }
